...
CODE_MAP_INFO = [
    {
        "SOURCE_DB_ACCESS_INFO": DEV_PO,
        "SOURCE_TABLE": "PO_COMM_CD",
        "SOURCE_COLS": ["COMM_CD", "COMM_CD_NM"],
    },
    {
        "SOURCE_DB_ACCESS_INFO": DEV_PO,
        "SOURCE_TABLE": "PO_ORGN",
        "SOURCE_COLS": ["ORGN_ID", "ORGN_NM"],
    },
    {
        "SOURCE_DB_ACCESS_INFO": DEV_PO,
        "SOURCE_TABLE": "PO_TECL_CD",
        "SOURCE_COLS": ["TECL_CD", "TECL_NM"],
    },
]
    ...
    "DESIGN": {
        "MERGE_PROCESS": [
            ...
            },
            {
                ...
                "POSTPROCESS": [
                    {"drop_duplicates": {"target_cols": [
                        'SBJT_ID', 'PRG_SN', 'PTC_PRG_SN'], "params":{}}}
                ],
                "ADD_COMMENT": "Y",
                "REMARK": """
                    -연구 개발 과제
            ...
            },
            {
                ...
                "SOURCE_COLS": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN", "KWD_NM", "KWD_OR"],
                "JOIN_KEY":["SBJT_ID", "PRG_SN", "PTC_PRG_SN"],
                "PREPROCESS":[
                    {"sort": {"params": {"sort_by_cols": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN", "KWD_OR"], "order_by":"asc"}}},
                    {"custom_groupby_concat": {"params": {"sum_cols": ["KWD_NM"], "sep":",", "group_col":["SBJT_ID", "PRG_SN", "PTC_PRG_SN"]}}},
                    {"drop_duplicates": {"target_cols": [
                        'SBJT_ID', 'PRG_SN', 'PTC_PRG_SN'], "params":{}}},
                    {"remove_cols":{"target_cols":["KWD_OR"]}}
                ],
                "ADD_COMMENT": "Y",
                "REMARK": """
            ...
            },
            {
                ...
                "PREPROCESS":[
                    ...
                    {"comm_cd_join": {"target_cols": [], "params":{"code_map_table": "PO_COMM_CD", "on": "LOC_ZNE_SE",
                                                                   "right_on": "COMM_CD", "code_map_col": "COMM_CD_NM", "new_col_name": "LOC_ZNE_SE_NM"}}},
                    {"comm_cd_join": {"target_cols": [], "params":{"code_map_table": "PO_ORGN", "on": "AGRT_ORGN_ID",
                                                                   "right_on": "ORGN_ID", "code_map_col": "ORGN_NM", "new_col_name": "AGRT_ORGN_NM"}}},
                    {"fillna":{"target_cols":["RSCH_ORGN_ID", "RSCH_ORGN_ROLE_SE", "AGRT_ORGN_ID", "RSCH_ORGN_NM", "NAT_SE", "LOC_ZNE_SE"],"params":{"replace":None}}},
                    {"custom_all_concat": {"params": {"group_cols": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN"], "col_name": "PS_SBJT_RSCH_ORGN","remove_col_yn":"Y"}}},
                    {"fillna":{"target_cols":["PS_SBJT_RSCH_ORGN"],"params":{"replace":[]}}},
                ],
                "POSTPROCESS":[
                    {"col_dict_to_json":{"target_cols":["PS_SBJT_RSCH_ORGN"]}}
                ],
                "REMARK": """
                    - 과제 연구 기관
            ...
            },
            {
                ...
                "SOURCE_COLS": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN", "RSCR_MBR_ID", "RSCR_ROLE_SE", "RSCR_NM", "NAT_SE", "SCH_NM", "PSTN_NM", "MAJ_NM", "DEG_SE",
                                "RSCH_CHRG_FILD_CN", "ETC_SBJT_PTCP_PT", "ETC_PTCP_SBJT_CT", "MAJ_SERS_SE"],
                "JOIN_KEY": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN"],
                "SELECT_CONDITION": "",
                "FILTER_BY_COL_VALS": ["SBJT_ID"],
                "PREPROCESS":[
                    ...
                    {"fillna":{"target_cols":["RSCR_MBR_ID", "RSCR_ROLE_SE", "RSCR_NM", "NAT_SE", "SCH_NM", "PSTN_NM", "MAJ_NM", "DEG_SE",
                                "RSCH_CHRG_FILD_CN", "ETC_SBJT_PTCP_PT", "ETC_PTCP_SBJT_CT", "MAJ_SERS_SE"],"params":{"replace":None}}},
                    {"custom_all_concat": {"params": {"group_cols": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN"], "col_name": "PS_SBJT_RSCH_MBR","remove_col_yn":"Y"}}},
                    {"fillna":{"target_cols":["PS_SBJT_RSCH_MBR"],"params":{"replace":[]}}},

                ],
                "POSTPROCESS":[
                    {"col_dict_to_json":{"target_cols":["PS_SBJT_RSCH_MBR"]}}
                ],
                "REMARK": """
                    - 과제 연구 인력
                    - 컬럼명: ~~~,연구자 인력 ID, 연구자 역할 구분, 연구자 명, 국가 구분,학교 명, 	직위 명,전공 명, 학위 구분,
                    	연구 담당 분야 내용, 기타 과제 참여 비율,기타 참여 과제 수, 전공 계열 구분
            ...
            },
            {
                ...
                "PREPROCESS":[
                    ...
                    {"comm_cd_join": {"target_cols": [], "params":{"code_map_table": "PO_COMM_CD", "on": "ORGN_TP_SE",
                                                                   "right_on": "COMM_CD", "code_map_col": "COMM_CD_NM", "new_col_name": "ORGN_TP_SE_NM"}}},
                    {"comm_cd_join": {"target_cols": [], "params":{"code_map_table": "PO_COMM_CD", "on": "NAT_SE",
                                                                   "right_on": "COMM_CD", "code_map_col": "COMM_CD_NM", "new_col_name": "NAT_SE_NM"}}},
                    {"fillna":{"target_cols":["SBJT_ID", "PRG_SN", "PTC_PRG_SN", "SPRT_ORGN_ID", "SPRT_ORGN_ROLE_SE", "SPRT_ORGN_NM", "ORGN_TP_SE", "NAT_SE", "ORGN_ROLE_DSCR"],"params":{"replace":None}}},                                                                   
                    {"custom_all_concat": {"params": {"group_cols": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN"], "col_name": "PS_SBJT_SPRT_ORGN","remove_col_yn":"Y"}}},
                    {"fillna":{"target_cols":["PS_SBJT_SPRT_ORGN"],"params":{"replace":[]}}},
                ],
                "POSTPROCESS":[
                    # {"col_dict_to_json":{"target_cols":["PS_SBJT_SPRT_ORGN"]}},
                ],
                "REMARK": """
                    - 과제 지원 기관
            ...
            },
            {
                ...
                "SOURCE_COLS": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN", "SBJT_TECL_CD", "PRIO_RK"],
                "SELECT_CONDITION": "SBJT_TECL_GRP_CD = 'T0001'",
                "JOIN_KEY":["SBJT_ID", "PRG_SN", "PTC_PRG_SN"],
                "PREPROCESS": [
                    {"sort": {"params": {"sort_by_cols": [
                        "SBJT_ID", "PRG_SN", "PTC_PRG_SN", "PRIO_RK"], "order_by":"asc"}}},
                    {"drop_duplicates": {"target_cols": [
                        'SBJT_ID', 'PRG_SN', 'PTC_PRG_SN'], "params":{}}},
                    {"comm_cd_join": {"target_cols": [], "params":{"code_map_table": "PO_TECL_CD", "on": "SBJT_TECL_CD",
                                                                   "right_on": "TECL_CD", "code_map_col": "TECL_NM", "new_col_name": "SBJT_TECL_CD_NM"}}},
                ],
                "REMARK": """
                    -과제 기술및 유형/특성 분류
                    -컬럼명: ~~~, 과제 기술분류 코드
            ...
            },
            {
                ...
                "JOIN_KEY":["SBJT_ID", "PRG_SN", "PTC_PRG_SN"],
                # "SELECT_CONDITION": "SBJT_STEP=0",
                "PREPROCESS": [

                ],
                # "TARGET_DB_ACCESS_INFO": "dev_anal",
                # "TARGET_TABLE": "ANALYSIS",
                "POSTPROCESS":[
                    {"drop_duplicates": {"target_cols": [
                        'SBJT_ID', 'PRG_SN', 'PTC_PRG_SN'], "params":{}}}
                ],
                "REMARK": """
                    - 과제 종합 연차
                    - 컬럼명: 	과제단계, 연구 목표 내용, 연구 범위 내용, 기대 효과 내용, 예상 성과 내용
            ...
            },
            {
                "SOURCE_DB_ACCESS_INFO": DEV_PS,
                "SOURCE_TABLE": "PS_SBJT_KWD",
                "SELECT_CONDITION": "1=2",
                "JOIN_KEY": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN"],
                "SOURCE_COLS": ["SBJT_ID", "PRG_SN", "PTC_PRG_SN"],
                "TARGET_DB_ACCESS_INFO": "parquet",
                "TARGET_TABLE": "/data/temp_parquet/temp1",
                # "TARGET_DB_ACCESS_INFO": "dev_anal",
                # "TARGET_TABLE": "ANALYSIS",
            }
        ]
